...
data = load_data(r'intel_qa_dataset.csv')  # Replace with the actual path to your dataset
...
def generate_llama2_response(prompt_input):
    ...
    response_row = data[data['question'].str.contains(prompt_input, case=False, na=False)]
    if not response_row.empty:
        answer = response_row.sample(n=1).iloc[0]['answer']
    else:
        # If no suitable response found, use the model to generate one
